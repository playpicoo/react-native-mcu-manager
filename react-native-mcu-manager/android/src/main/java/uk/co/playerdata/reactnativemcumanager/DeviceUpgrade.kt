...
class DeviceUpgrade<McuMgrTransport>(
    ...
    private fun doUpdate(updateBundleUri: Uri) {
        ...
        val windowUploadCapacity = updateOptions.windowUploadCapacity ?: 1
        val alignmentInt = updateOptions.memoryAlignment ?: 1
        val memoryAlignment = MemoryAlignments[alignmentInt] ?: 1

        val settings = Settings.Builder()
            .setEstimatedSwapTime(estimatedSwapTime)
            .setWindowCapacity(windowUploadCapacity)
